            ...
            <div class="col-lg-6 col-7">  
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Stok Alkon</li>
                </ol>
              </nav>
            </div>  
          </div>
                ...
                <tbody class="list">
                 ...
                 <?php $i = 1; foreach ($alkons as $row): ?> 
                  <tr> 
                    ...
                    <td>
                      <?php if ($this->Stok_m->get_num_row(['id_alkon' => $row->id_alkon , 'id_klinik' => $kl->id_klinik] ) != 0 ) {
                        echo $this->Stok_m->get_row(['id_alkon' => $row->id_alkon , 'id_klinik' => $kl->id_klinik] )->stok;
                      }else{
                        echo "0";
                      } ?>
                    </td>  
