  ...
  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="<?=base_url('pimpinan')?>">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav"> 
            <li class="nav-item">
              <a class="nav-link <?php if($index == 2){ echo 'active'; } ?>" href="<?=base_url('pimpinan/laporan')?>">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($index == 3){ echo 'active'; } ?>" href="<?=base_url('pimpinan/alkon')?>">
                <i class="ni ni-book-bookmark text-black"></i>
                <span class="nav-link-text">Data Alkon</span>
              </a>
            </li>
          ...
          <ul class="navbar-nav mb-md-3">
             <li class="nav-item">
              <a class="nav-link <?php if($index == 8){ echo 'active'; } ?>" href="<?=base_url('pimpinan/profile')?>"  >
